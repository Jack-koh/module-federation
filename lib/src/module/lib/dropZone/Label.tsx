...
const InvalidFile: React.FC<{ fileName: string; extensions: string[] }> = ({ fileName, extensions }) => (
  <div className="label">
    <div className="valid-text">
      ...
      <div className="normal-text">{`확장자가 ${extensions.join(", ")}인 파일만 업로드 가능합니다.`}</div>
    </div>

    <div className="gray-text">다시 업로드 하시려면 파일을 드래그 하거나, 여기를 눌러주세요.</div>
  </div>
);
